...
namespace UserModule.Application.Interfaces.Repositories
{
    public interface IUserRepository
    {
        ...
        Task<UserModule.Domain. Entities.User> GetByIdWithPhoneNumbersAsync(Guid userId, CancellationToken cancellationToken, bool includeDeleted = false, bool includeBanned = false);
